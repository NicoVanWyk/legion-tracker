...
import AoSArmyKeywordTypes from '../../enums/aos/AoSArmyKeywordTypes';
...
const ArmyKeywordForm = () => {
    ...
    const [formData, setFormData] = useState({
        name: '',
        keywordType: AoSArmyKeywordTypes.BATTLE_TRAIT,
        faction: '',
        description: '',
        effectText: '',
        isUniversal: false
    ...
    const fetchKeyword = useCallback(async () => {
        ...
        try {
            ...
            if (keywordDoc.exists()) {
                ...
                setFormData({
                    name: data.name || '',
                    keywordType: data.keywordType || AoSArmyKeywordTypes.BATTLE_TRAIT,
                ...
                <Form onSubmit={handleSubmit}>
                        ...
                        <Col md={8}>
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control
                                    ...
                                    placeholder="e.g., Scions of the Storm, Battle Trait, Lord of the Host"
                                    required
                                />
                            </Form.Group>
                        </Col>
                        ...
                        <Col md={4}>
                            <Form.Group className="mb-3">
                                ...
                                <Form.Select
                                    ...
                                    required
                                >
                                    {Object.values(AoSArmyKeywordTypes).filter(t => typeof t === 'string').map(type => (
                                ...
                                <Form.Text className="text-muted">
                                    {AoSArmyKeywordTypes.getDescription(formData.keywordType)}
                                </Form.Text>
                            </Form.Group>
                        </Col>
                    </Row>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            ...
                            onChange={handleChange}
                            placeholder="Detailed rules text for the keyword effect"
                            rows={6}
                        />
                    </Form.Group>
                        ...
                        <Card className="keyword-preview">
                            <Card.Header>
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <Badge bg="info">
                                        {AoSArmyKeywordTypes.getDisplayName(formData.keywordType)}
                                    </Badge>
                                </div>
                            </Card.Header>
                            <Card.Body>
                                ...
                                <p className="mb-0" style={{whiteSpace: 'pre-wrap'}}>
                                    {formData.effectText || 'Effect text will appear here'}
                                </p>
                            </Card.Body>
                        </Card>
                    </div>
