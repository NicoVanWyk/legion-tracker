// src/components/units/UnitDetail.js (Updated with abilities, upgrades, and model counts)
                ...
                if (unitDoc.exists()) {
                    ...
                    unitData.upgradeSlots?.forEach(slot => {
                        if (slot.equippedUpgrades) {
                            allEquippedUpgrades.push(...slot.equippedUpgrades);
                        }
                    });
                            ...
                            <Row>
                                <Col md={12}>
                                    <p>
                                        ...
                                        Min: {unit.minModelCount || 1} |{' '}
                                        Current: {unit.currentModelCount || 1}
