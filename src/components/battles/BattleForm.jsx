...
const BattleForm = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        blueFaction: '',
        redFaction: '',
        blueCommandCard: null,
        redCommandCard: null,
        blueCommandCardDetails: null,
        redCommandCardDetails: null,
        currentRound: 1,
                ...
                if (preselectedArmyId) {
                    ...
                    if (preselectedArmy) {
                        setFormData(prev => ({
                            ...
                            blueFaction: preselectedArmy.faction
                        }));
    ...
    const loadArmyUnits = async (armyId, side) => {
        ...
        try {
                ...
                if (unitDoc.exists()) {
                    ...
                    units.push({
                        ...
                        tokens: {
                            ...
                            dodge: 0,
                            surge: 0,
                            shield: unitData.keywords?.includes('shielded_1') ? 1 :
                                (unitData.keywords?.includes('shielded_2') ? 2 :
                                    (unitData.keywords?.includes('shielded_3') ? 3 :
                                        (unitData.keywords?.includes('shielded_4') ? 4 : 0))),
                            ion: 0,
                            smoke: 0,
                            standby: 0
                        },
            ...
            setFormData(prev => {
                const updates = {
                    [`${side}Units`]: units,
                    [`${side}Army`]: armyData.name,
                    [`${side}Faction`]: armyData.faction
                };
                            ...
                            <Card className="mb-3" border="primary">
                                ...
                                <Card.Body>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        {formData.blueFaction && (
                                            <div className="mt-1">
                                                <strong>Faction:</strong> {formData.blueFaction}
                                            </div>
                                        )}
                                    </div>
                                </Card.Body>
                            ...
                            <Card className="mb-3" border="danger">
                                ...
                                <Card.Body>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        {formData.redFaction && (
                                            <div className="mt-1">
                                                <strong>Faction:</strong> {formData.redFaction}
                                            </div>
                                        )}
                                    </div>
                                </Card.Body>
