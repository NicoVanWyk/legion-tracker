...
const Profile = () => {
  ...
  const validateForm = () => {
    ...
    // Email or password change requires reauthentication
    if ((isEmailChanged || isPasswordChanged) && !userProfile.currentPassword) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userProfile.email !== currentUser.email || userProfile.newPassword) {
        // Reauthenticate user
      ...
      <Form onSubmit={handleSubmit}>
        ...
        {showPasswordConfirm && (
          <Form.Group controlId="currentPassword" className="mb-3">
            ...
            />
            <Form.Text className="text-muted">
              Please confirm your current password to update email or password
            </Form.Text>
          </Form.Group>
        )}
